...
class ViewController: UIViewController {
    ...
    @IBAction func Play(_ sender: Any) {
        ...
        TapsValid = true
        BallChange = true
        //defaults.set(HighScore, forKey: "playbutton")
        Score = 0
        playbutton = playbutton + 1
        self.Play.setTitle(" Click to Play ", for: .normal)
    ...
    override func viewDidLoad() {
        ...
        //playbutton = defaults.string(forKey: "playbutton")!
        self.GameOver.isHidden = true
        //self.Retry.isHidden = true
    ...
    @objc func movement() {
        ...
        if Ball.frame.intersects(Pillar1.frame) {
            ...
            self.PillarTop.center = CGPoint(x:Pillar5.center.x, y:Pillar5.center.y - 35)
    ...
    func gameOver () {
        ...
        let a = "The Game is Over!!!!!!!\nCurrent score\n"
        let b = "\nHighscore \n"
        
        self.ScoreOnBoard.text = a + String(Score) + b + String(HighScore)
        //self.HighScoreOnBoard.text =
